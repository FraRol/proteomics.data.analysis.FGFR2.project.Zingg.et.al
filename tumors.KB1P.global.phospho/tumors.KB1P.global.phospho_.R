...
#check all NA rows and remove
Tiox.Ewa.ms.tums_expanded_log2_normclass1.PS_ssPTMSEA$na.rows <- pbapply(Tiox.Ewa.ms.tums_expanded_log2_normclass1.PS_ssPTMSEA[, c("Int.1_2", "Int.3_4", "Int.9_10","Int.11_12","Int.17_18","Int.19_20","Int.25_26","Int.27_28", "Int.33_34","Int.35_36", "Int.41_42","Int.43_44",
                                                                                                                           "Int.65_66","Int.67_68","Int.73_74","Int.75_76", "Int.81_82","Int.83_84","Int.89_90","Int.91_92", "Int.57_58","Int.59_60",
                                                                                                                           "Int.49_50","Int.51_52")], 1, function(x) sum(is.na(x)))
glimpse(Tiox.Ewa.ms.tums_expanded_log2_normclass1.PS_ssPTMSEA)
table(Tiox.Ewa.ms.tums_expanded_log2_normclass1.PS_ssPTMSEA$na.rows)

Tiox.Ewa.ms.tums_expanded_log2_normclass1.PS_ssPTMSEA <- Tiox.Ewa.ms.tums_expanded_log2_normclass1.PS_ssPTMSEA %>% filter(na.rows < 24) %>% select(-na.rows)
glimpse(Tiox.Ewa.ms.tums_expanded_log2_normclass1.PS_ssPTMSEA) #13398
...
table(duplicated(Tiox.Ewa.ms.tums_expanded_log2_normclass1.PS_ssPTMSEA$aa15.window))#2672 #2532
...
glimpse(unique.15aa.windows) #11099 #10866
...
nrow(gene.pattern.PTM.SEA.input) #11099 #10866
...
write_gct(gene.pattern.PTM.SEA.input_GCT.2, "KB1P.tums.class1.PS.ssPTMSEA.input2.gct")
